...
Unifying code in a single file. 
Latest file is LightPainting_2_2.
Will move older files to directory old/

Going to adapt code for nano card.
...
// These values are for digital pin 3 on Arduino Nano CH340
#define PIXEL_PORT  PORTD  // Port of the pin the pixels are connected to
#define PIXEL_DDR   DDRD  // Port of the pin the pixels are connected to
#define PIXEL_BIT   3      // Bit of the pin the pixels are connected to
...
//       rArray[i]= int(random(0,254)*intensity);
//      gArray[i]= int(random(0,254)*intensity);
//      bArray[i]= int(random(0,254)*intensity);
