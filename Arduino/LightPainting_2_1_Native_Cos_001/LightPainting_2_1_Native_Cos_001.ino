...
Serial.println(roof_intensity);
  ...
  Serial.println(x);
   ...
   { 
     rArray[i]= (cos(M_PI*i/72)+cos(M_PI*x/32))/2*roof_intensity;
      if (rArray[i]>roof_intensity) rArray[i]=0;
      gArray[i]= (cos(M_PI*i/36)+cos(M_PI*x/64))/2*roof_intensity;
      if (gArray[i]>roof_intensity) gArray[i]=0;

      bArray[i]= (cos(M_PI*i/18)+cos(M_PI*x/128))/2*roof_intensity;
